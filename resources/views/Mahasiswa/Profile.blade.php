...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function GetProfile() {
            $.ajax({
                type: "GET",
                url: "/mahasiswa/profile/get",
                success: function(data) {
                    if (data.profile != null) {
                        $("#profile-id").val(data.profile.id);
                        $("#nim").val(data.profile.nim);
                        ...
                        $("#program_studi").val(data.profile.program_studi);
        ...
        $("#form_profile").submit(function(e) {
            ...
            if(email == "" || nim == "" || nama_lengkap == "" || no_hp == "" || tempat_lahir == "" || tgl_lahir == "" || alamat == ""){
            ...
            if (profile_id == "" || profile_id == null) {
                $.ajax({
                    ...
                    success: function(d) {
                        if (d.IsSuccess) {
                            swal("Success", "Profile " + nama_lengkap + " has been added", "success");
                            GetProfile();
                        } else {
                            swal("Error", "Error when add Profile " + nama_lengkap, "error");
                        }
                    },
                    fail: function() {
                        swal("Error", "Error when add Profile " + nama_lengkap, "error");
                ...
                $.ajax({
                    type: 'POST',
                    url: '/mahasiswa/profile/' + profile_id,
                    dataType: 'json',
                    contentType: false,
                    cache: false,
                    processData: false,
